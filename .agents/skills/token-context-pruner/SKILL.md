---
name: token-context-pruner
description: Compress context size before LLM generation passes in local_learningsuccess by injecting minimal interfaces and using structured JSON contracts.
---

# Token Context Pruner (`token-context-pruner`)
