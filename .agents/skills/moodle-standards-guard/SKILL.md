---
name: moodle-standards-guard
description: Enforce Moodle 5.x coding conventions and quality standards before any file write operation or code generation pass in local_learningsuccess.
---

# Moodle Standards Guard (`moodle-standards-guard`)
